...
public final class status_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      // /libs/composum/nodes/pckgmgr/jcrpckg/general/status.jsp(6,0) name = id type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setId("pckg");
      // /libs/composum/nodes/pckgmgr/jcrpckg/general/status.jsp(6,0) name = type type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cpn_005fcomponent_005f0.setType("com.composum.sling.core.pckgmgr.view.PackageBean");
      // /libs/composum/nodes/pckgmgr/jcrpckg/general/status.jsp(6,0) name = scope type = java.lang.String reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_cpn_005fcomponent_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\n");
          out.write("    <ul class=\"status-block indicator-block ");
          ...
          out.write("\">\n");
          out.write("        <li class=\"status-indicator install-status\"><span class=\"is-installed\">installed</span><span class=\"not-installed\">not installed</span></li>\n");
          out.write("        <li class=\"status-indicator sealed-status\"><span class=\"is-sealed\">sealed</span><span class=\"not-sealed\">not sealed</span></li>\n");
          out.write("        <li class=\"status-indicator valid-status\"><span class=\"is-valid\">valid</span><span class=\"not-valid\">invalid !</span></li>\n");
          out.write("    </ul>\n");
